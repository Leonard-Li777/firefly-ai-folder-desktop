...
import { MinimumUnitResult } from '@firefly/types'
import { t } from '@app/languages'
import { FileCategory, isCategory } from '@firefly/shared'
...
function isVideo(ext: string) {
  return isCategory(ext, FileCategory.VIDEO)
}
function isDoc(ext: string) {
  return isCategory(ext, FileCategory.DOCUMENT)
}
