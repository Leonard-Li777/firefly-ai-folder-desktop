...
import {
  filterIgnoredFilesByRules,
  logger,
  LogCategory,
  shouldIgnoreFileByRules
} from '@firefly/shared'
 ...
 * 获取系统预设的忽略规则
 */
export function getSystemIgnoreRules(): IIgnoreRule[] {
  try {
...
export function loadIgnoreRules(): IIgnoreRule[] {
  try {
    ...
    let rules = ConfigOrchestrator.getInstance().getValue<IIgnoreRule[]>('IGNORE_RULES')
