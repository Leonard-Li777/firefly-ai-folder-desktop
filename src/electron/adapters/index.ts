...
import type { ICoreEngineAdapters } from '@firefly/core-engine'
 ...
 */
export async function createCoreEngineAdaptersWithAIService(
  aiService: ILlamaIndexAIService
): Promise<ICoreEngineAdapters> {
  const databaseAdapter = await createDatabaseAdapter()
