...
import { debounce } from '@yonuc/shared'
...
import { SUPPORTED_LANGUAGES_KEY, CONFIG_KEY_TO_RENDERER_FIELD_MAP } from '@yonuc/shared'
 ...
 */
const configKeyToRendererFieldMap = CONFIG_KEY_TO_RENDERER_FIELD_MAP as Record<ConfigKey, keyof AppConfig | null>
...
if (typeof window !== 'undefined' && window.electronAPI) {
  window.electronAPI.getConfig().then(config => useSettingsStore.getState().updateConfig(config, { internal: true }))
