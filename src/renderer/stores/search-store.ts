...
interface SearchState {
  ...
  // 虚拟目录搜索
  analyzedDirectoryKeyword: string
  setAnalyzedDirectoryKeyword: (keyword: string) => void
  ...
  addSearchHistory: (keyword: string, type: 'real-directory' | 'virtual-directory' | 'analyzed-directory') => void
  clearSearchHistory: () => void
  removeSearchHistoryItem: (id: string) => void
  getSearchSuggestions: (type: 'real-directory' | 'virtual-directory' | 'analyzed-directory', currentKeyword: string) => string[]
...
export const useSearchStore = create<SearchState>((set, get) => ({
  ...
  setAnalyzedDirectoryKeyword: (keyword: string) => {
    set({ analyzedDirectoryKeyword: keyword, virtualDirectoryKeyword: keyword })
  },

  // 设置整理后虚拟目录搜索关键词（只更新 virtualDirectoryKeyword）
  setVirtualDirectoryKeyword: (keyword: string) => {
    set({ virtualDirectoryKeyword: keyword })
  },
  
  // 添加搜索历史
  addSearchHistory: (keyword: string, type: 'real-directory' | 'virtual-directory' | 'analyzed-directory') => {
  ...
  // 获取搜索建议
  getSearchSuggestions: (type: 'real-directory' | 'virtual-directory' | 'analyzed-directory', currentKeyword: string) => {
    const state = get()
