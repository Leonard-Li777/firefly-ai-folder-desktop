...
import { FirecoreRulesDialog } from './FirecoreRulesDialog'
      ...
      {isOpen &&
        createPortal(
          <div
            ref={menuRef}
            className={cn(
              'fixed z-[100] w-64 bg-card text-card-foreground border border-border rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200'
            )}
            style={{
          ...
          >
            ...
            <div className="p-4 pb-2.5 relative">
              ...
              >
                ...
                <div
                  className={cn(
                    'absolute -top-12 -right-12 w-24 h-24 rotate-45 pointer-events-none z-20 flex items-end justify-center pb-2 font-black text-white shadow-sm',
                    tier === UserTier.ENTERPRISE
                      ? 'bg-purple-600'
                      : tier === UserTier.PRO
                        ? 'bg-amber-500'
                ...
                >
                  <span className="text-[12px] tracking-wider leading-none select-none">
                    {tierConfig.label}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2.5 relative z-10 pt-3 border-t border-border/40">
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 h-8 rounded-xl text-xs font-bold transition-all hover:scale-[1.02] active:scale-95 duration-200 shadow-sm hover:shadow-md border border-transparent bg-gradient-to-r from-sky-500 to-blue-600 text-white font-bold hover:from-sky-600 hover:to-blue-700"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 h-8 rounded-xl text-xs font-bold border border-amber-500/30 bg-background/50 text-secondary-foreground hover:bg-accent transition-all hover:scale-[1.02] active:scale-95 duration-200"
                  >
            ...
            <div className="p-2 space-y-0.5">
              ...
              >
                <Settings className="w-4 h-4 opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all" />
              ...
              >
                <ListOrdered className="w-4 h-4 opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all text-primary" />
                <span className="font-medium">{t('分析队列')}</span>
              </button>
              <button
                className="w-full flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl text-muted-foreground hover:text-foreground hover:bg-accent/60 transition-all duration-200 group active:scale-[0.98]"
                onClick={() =>
              ...
              >
                <Bot className="w-4 h-4 opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all text-purple-500" />
                <span className="font-medium">{t('与本地AI私密聊天')}</span>
              </button>
              <button
                className="w-full flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl text-muted-foreground hover:text-foreground hover:bg-accent/60 transition-all duration-200 group active:scale-[0.98]"
                onClick={() =>
              ...
              >
                <RotateCcw className="w-4 h-4 opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all" />
                <span className="font-medium">{t('重置布局')}</span>
              </button>
              ...
              >
                <MessageCircle className="w-4 h-4 opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all text-sky-500" />
                <span className="font-medium">{t('知乎萤核圈子')}</span>
              </button>
              <button
                className="w-full flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl text-muted-foreground hover:text-foreground hover:bg-accent/60 transition-all duration-200 group active:scale-[0.98]"
                onClick={() =>
              ...
              >
                <QrCode className="w-4 h-4 opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all text-green-500" />
                <span className="font-medium">{t('扫码加微信群')}</span>
              </button>
              <div className="my-1 border-t border-border/30 mx-2" />
              <button
                className="w-full flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl text-muted-foreground hover:text-foreground hover:bg-accent/60 transition-all duration-200 group active:scale-[0.98]"
              ...
              >
                <Info className="w-4 h-4 opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all" />
                <span className="font-medium">{t('关于')}</span>
              </button>
            </div>
          </div>,
          document.body
