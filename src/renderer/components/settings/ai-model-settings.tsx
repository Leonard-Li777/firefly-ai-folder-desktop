            ...
            <div className="flex items-center gap-2 mb-2 flex-wrap">
              ...
              <div className="flex gap-1.5 flex-wrap">
                ...
                {model.intelligenceLevel && (
                  <Badge
                    variant="outline"
                    className={`text-[9px] font-black h-4 px-1.5 uppercase tracking-tighter flex items-center gap-1 ${
                      model.intelligenceLevel === 1
                        ? 'bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border-emerald-500/30'
                        : model.intelligenceLevel === 2
                          ? 'bg-blue-500/15 text-blue-600 dark:text-blue-400 border-blue-500/30'
                          : model.intelligenceLevel === 3
                            ? 'bg-amber-500/15 text-amber-600 dark:text-amber-400 border-amber-500/30'
                            : 'bg-purple-500/15 text-purple-600 dark:text-purple-400 border-purple-500/30 font-extrabold'
                    }`}
                  >
