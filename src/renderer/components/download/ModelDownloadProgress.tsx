      ...
      <div className="flex items-start ring-input justify-between gap-2">
        <div className="flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-8 gap-2 text-xs text-muted-foreground mb-3">
            {totalBytes > 0 && (
              <div className="inline-flex col-span-4 items-center rounded-md border border-border bg-muted px-2.5 py-1 text-xs font-medium text-muted-foreground">
                {formatBytes(receivedBytes)} / {formatBytes(totalBytes)}
              </div>
            )}
            {speedBps > 0 && (
              <div className="inline-flex col-span-2 items-center rounded-md border border-border bg-muted px-2.5 py-1 text-xs font-medium text-muted-foreground">
            ...
            <div className="mt-3 p-3 rounded-lg bg-destructive/10 border border-destructive/20 text-destructive-foreground text-sm">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="mt-1 text-destructive/80">{t('{error}，请稍后再试或选择其它模型下载', { error })}</p>
                  {onRetry && (
                    <Button
                      variant="outline"
                      size="sm"
