      ...
      const originalTree: VirtualDirectoryNode[] = [
        {
          ...
          files: [
            {
              fileId: 99,
              fileFingerprint: 'fp-99',
              name: '腾讯会议.lnk',
              relativePath: 'C:\\Users\\Desktop\\腾讯会议.lnk'
            }
          ]
        },
        {
          ...
          files: [
            {
              id: 50,
              fileId: 50,
              fileFingerprint: 'fp-50',
              name: '未归类文档.pdf',
              relativePath: 'D:\\未归类文档.pdf'
            }
          ]
        }
      ]
      ...
      const tree: VirtualDirectoryNode[] = [
        {
          ...
          subdirectories: [],
          files: [
            { id: 1, fileId: 1, fileFingerprint: 'fp-1', name: 'a.txt', relativePath: 'a.txt' }
          ]
        },
        {
          name: '未归类',
          ...
          subdirectories: [],
          files: [
            { id: 2, fileId: 2, fileFingerprint: 'fp-2', name: 'b.txt', relativePath: 'b.txt' },
            { id: 3, fileId: 3, fileFingerprint: 'fp-3', name: 'c.txt', relativePath: 'c.txt' }
          ]
        }
      ]
