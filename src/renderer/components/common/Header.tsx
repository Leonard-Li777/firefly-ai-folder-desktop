...
export const Header: React.FC<IHeaderProps> = ({ title, showDirectorySelector }) => {
  ...
  return (
    <header
      className="bg-card border-b border-border px-4 py-2 flex items-center z-10 shadow-sm"
      ...
      >
        <div className="flex items-center space-x-1">
          ...
          >
            <MaterialIcon
              icon="close"
              className="text-muted-foreground group-hover:text-destructive-foreground text-lg"
            />
          </button>
        </div>
      </div>
