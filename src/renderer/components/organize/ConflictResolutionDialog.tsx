...
import { FileConflict, ConflictResolutionOptions } from '@firefly/types/organize-types'
        ...
        <div className="flex-1 overflow-y-auto mb-4">
          ...
          <div className="space-y-3">
            {conflicts.slice(0, 5).map((conflict, index) => (
              <div
                key={index}
                className="border border-border rounded-lg p-3 bg-muted/30 dark:bg-muted/10"
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1 min-w-0">
                    ...
                    <p
                      ...
                      title={path.dirname(conflict.targetPath)}
                    >
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div className="bg-background p-2 rounded border border-border">
                    ...
                    <p className="text-muted-foreground text-xs">
                      {formatDate(conflict.existingFile.modifiedAt)}
                    </p>
                  </div>
                  <div className="bg-blue-50 dark:bg-blue-900/20 p-2 rounded border border-blue-200 dark:border-blue-900/50">
                    ...
                    <p className="text-blue-600 dark:text-blue-400 text-xs">
                      {formatDate(conflict.newFile.modifiedAt)}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="border-t border-border pt-4 mb-4 space-y-4">
          ...
          <label className="flex items-center cursor-pointer">
            ...
            <span className="text-sm text-muted-foreground">
              {t('应用于所有 {count} 个冲突文件', { count: conflicts.length })}
            </span>
          </label>
        </div>
